...
namespace SerieMovieAPI.Migrations
{
    ...
    [Migration("20211203131907_Agregando nombre, apellido y password sin hash a User")]
    partial class AgregandonombreapellidoypasswordsinhashaUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SerieMovieAPI.Models.DTOs.User.UserViewModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SerieMovieAPI.Models.DTOs.User.UserViewModel", null)
                        .WithMany()
